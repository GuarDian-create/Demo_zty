...
public class OrderController {
	...
	public String toPayFor(String orderId,HttpServletResponse response) throws Exception{
		...
		try {
			...
			System.out.println(result+"55555555");
//			输出
			response.setContentType("text/html; charset=utf-8");
			PrintWriter out = response.getWriter();
			System.out.println(result+"66666666");
			out.print(result);
